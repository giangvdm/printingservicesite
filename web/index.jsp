...
<body data-page-name="home">
    ...
    <section class="section" id="">
        <div class="container">
            <h2 class="section__main-title">Trang chủ</h2>
            ...
            <article class="article" id="phan-hoi">
                ...
                <div class="horizontal-card__container">
                    ...
                    <div class="horizontal-card__content-holder">
                        ...
                        <div class="horizontal-card__content">
                            ...
                            với khối lượng công việc nặng thì việc tự in thủ công tốn rất nhiều thời gian. Nhờ có dịch vụ tuyệt vời tại Ao Sen
                            Đệ nhất mà tôi vừa tiết kiệm được thời gian cho việc chuẩn bị giấy tờ, vừa có thể hoàn thành sớm công việc và dành thêm
                ...
                <div class="horizontal-card__container">
                    ...
                    <div class="horizontal-card__content-holder">
                        ...
                        <div class="horizontal-card__content">
                            Quảng cáo là một ngành không những đòi hỏi sự sáng tạo mà còn yêu cầu rất cao về khối lượng công việc cần thực hiện,
                            từ vẽ đồ họa trên máy tính đến khi in ra thành phẩm như các tấm panel, standee hay thậm chí là những tấm biển cực lớn - quả
                            là không hề đơn giản. Thế nhưng, đội ngũ kỹ thuật viên có chuyên môn cao tại Ao Sen Đệ nhất dường như chứng minh điều ngược lại.
                            Các dự án quảng cáo hợp tác với Ao Sen Đệ nhất đã được thực hiện một cách bài bản, chuyên nghiệp, không tốn quá nhiều nỗ lực mà
