...
<body data-page-name="about">
    ...
    <section class="section" id="">
        <div class="container">
            <h2 class="section__main-title">Giới thiệu</h2>
                    ...
                    <div class="container u-full-width card-row__container">
                        ...
                        <div class="four columns card-row__card-item">
                            ...
                            <div class="card-item__description">
                                ...
                                và đặc biệt là ổn định và ít bị ảnh hưởng bởi tác động tiêu cực của giá cả thị trường chung.
                            </div>
                        </div>
                        <div class="four columns card-row__card-item">
            ...
            <article class="article" id="nguon-luc">
                ...
                <div class="article__content">
                    ...
                    <div class="content__item content__text">
                        ...
                        Daiya, máy 4 màu: Komori, máy 2 màu: Komori cùng với dây chuyền sản xuất sau in: máy cán, máy bế, máy
                        làm khuôn, máy ép nhũ, máy phủ uv, máy dán phong bì, máy khoan, máy keo sách, khâu sách, máy gấp
                        dán, máy đóng lỗ lịch…, Ao Sen Đệ nhất trở thành công ty in ấn, quảng cáo hàng đầu Việt Nam mang đến
            ...
            <article class="article" id="he-thong-nha-xuong">
                ...
                <div class="article__content">
                    ...
                    <figure class="content__item content__figure">
                        ...
                        <figcaption class="figure__caption">Kho chứa nguyên liệu và sản phẩm in ấn, đảm bảo an toàn, chống lại các điều kiện tự nhiên khắc nghiệt</figcaption>
                    </figure>
                </div>
            </article>
