...
<body data-page-name="manage-order">
    ...
    <main class="main-content container">
        <section class="section">
            <h2 class="main-content__title">Chỉnh sửa thông tin đơn hàng</h2>

            <form method="POST" action="EditOrder" class="form" id="order-form">
                <input type="hidden" name="id" value="${requestScope.currentOrder.getId()}">
                <fieldset id="press-info">
                    ...
                    <%-- <div class="row form__line-wrapper">
                        ...
                        <div class="seven columns">
                            <input type="file" accept=".txt,.doc,.docx,.odt,.pdf" multiple="true" id="file-upload" name="file-upload"
                                required>
                            <button class="button" id="preview-button" type="button" onclick="previewDoc();" disabled>Xem
                                trước</button>
                        </div>
                    </div>
                    ...
                    <div class="row form__line-wrapper">
                        ...
                        <div class="seven columns">
                            <input type="number" min="1" value="<%=orderRequirement[0].split(":")[1]%>" id="number-of-pages" name="number-of-pages" required>
                        </div>
                    </div>
                    <div class="row form__line-wrapper">
                        <div class="five columns form__label-container">
                        ...
                        <div class="seven columns">
                            <input type="number" min="1" value="<%=orderRequirement[1].split(":")[1]%>" name="number-of-copies" id="number-of-copies"
                                required>
                        </div>
                    </div>
                    <div class="row form__line-wrapper">
                    ...
                    <div class="row form__line-wrapper">
                        ...
                        <div class="seven columns">
                            <input type="checkbox" name="bookbinding" id="bookbinding" value="<%=orderRequirement[5].split(":")[1]%>">
                        </div>
                    </div>
                    <div class="row form__line-wrapper">
                        <div class="five columns form__label-container">
                    ...
                    <div class="row form__line-wrapper">
                        <div class="five columns form__label-container">
                            <label class="form__label" for="extra-requirement" id="css-extraRequirementTooltip"><i
                                    class="far fa-question-circle theme__tooltip-icon"></i>
                                &nbsp;Yêu cầu khác
                                <span class="tooltip__text">Các yêu cầu nằm ngoài đơn hàng sẽ được chúng tôi liên hệ
                                    tới quý khách hàng để trao đổi và tính giá theo thỏa thuận.</span>
                            </label>
                        </div>
                        <div class="seven columns">
                            <textarea name="extra-requirement" id="extra-requirement" rows="15">
                                <%
                    ...
                    <div class="row form__line-wrapper">
                        ...
                        <div class="seven columns">
                            <input type="number" id="total" name="total" value="<%=order.getTotal() %>" readonly>
                        </div>
                    </div>
                </fieldset>
                ...
                <fieldset id="customer-info">
                    ...
                    <div class="row form__line-wrapper">
                        ...
                        <div class="seven columns">
                            <input type="text" id="customer-name" name="customer-name" required value="<%=order.getCustomerName() %>">
                        </div>
                    </div>
                    <div class="row form__line-wrapper">
                        <div class="five columns form__label-container">
                        ...
                        <div class="seven columns">
                            <input type="tel" id="customer-tel" name="customer-tel" required value="<%=order.getCustomerPhone() %>">
                        </div>
                    </div>
                    <div class="row form__line-wrapper">
                        <div class="five columns form__label-container">
                        ...
                        <div class="seven columns">
                            <input type="email" id="customer-email" name="customer-email" required value="<%=order.getCustomerEmail() %>">
                        </div>
                    </div>
                    <div class="row form__line-wrapper">
                        <div class="five columns form__label-container">
                        ...
                        <div class="seven columns">
                            <textarea name="customer-address" id="customer-address" cols="30" rows="10">
                ...
                <div class="row form__line-wrapper">
                    <div class="six columns form__button-container">
                        <input class="form__button form__button--submit" type="submit" name="order" value="Cập nhật" id="submit-button">
                    </div>
                    <div class="six columns form__button-container">
