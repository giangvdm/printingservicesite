...
<head>
    <title>Thêm tài khoản khách hàng - Công ty In ấn Ao Sen đệ nhất photo</title>
    <meta charset="UTF-8">
            ...
            <form action="AddCustomer" method="POST" class="form" id="add-new-customer-form">
                ...
                <div class="row form__line-wrapper">
                    <div class="six columns form__button-container">
                        <input class="form__button form__button--submit" type="submit" value="Thêm" id="submit-button">
                    </div>
                    <div class="six columns form__button-container">
